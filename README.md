...
├── ⚙️  setup-validator.sh        # Automated validator setup
├── ▶️  start-validator.sh        # Start validator node
├── ⏹️  stop-validator.sh         # Stop validator node
├── 📊 check-status.sh          # Check validator status
├── 🔑 generate-keys.sh         # Generate validator keys
├── 🐳 docker-compose.yml       # Docker configuration
├── 📝 .env.example            # Environment template
├── 📁 config/
│   ├── 🧬 genesis.json        # Network genesis file
│   ├── 🌐 static-nodes.json   # Known peer nodes
│   └── ⚙️  config.toml         # Node configuration
└── 📁 scripts/
    ├── 💊 health-check.sh     # Health monitoring
    └── 🔄 update-node.sh      # Update validator
```
...
<details>
<summary>🌐 Validator Not Connecting to Network</summary>

```bash
# Check network connectivity
ping 194.164.150.169
...
# Compare with network explorer
# Visit: https://yoscan.net
```
